...
namespace Dabu\Service\Repositories;
...
class InitRepository
{
    ...
    {
        config(['app.item' => '12345678']);
        config(['app.verifier' => 'https://auth.dabu.com']);
        config(['app.push' => 'https://pusher.dabu.com']);
        config(['app.helpdoc' => 'https://helpdoc.dabu.com']);
    }
    ...
    public function product()
    {
        ...
        if (!$status) {
            ...
            $message = trans('install.contact_script_author');
